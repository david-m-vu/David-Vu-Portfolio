...
const Projects = (props) => {
  ...
  return (
    <motion.div id="Projects">
      ...
      <p>The projects I&apos;ve worked on so far have pushed me to optimize for real-time data processing and software scalability, with the goal of having both passive and active interactions translate to instant, useful results.</p>
