...
const About = (props) => {
    ...
    return (
        <motion.div id="About" className="inline-flex flex-col items-start px-4 pb-4">
            <div className="flex flex-col items-start gap-8">
                ...
                <div>
                    <p>Whether it&apos;s building web apps that bring people together or autonomous robots that solve real-world issues, I&apos;m always in pursuit of new ideas that can cultivate meaningful progress.</p>
                </div>
            </div>
