    ...
    return (
        <div id="NavBar" className="mb-4">
            <nav className="flex flex-col min-[556px]:flex-row min-[556px]:justify-between">
                <div className="left flex flex-row items-center gap-4 md:gap-8">
                    ...
                    <div className="relative group">
                        ...
                        <NavLink to="/"><div className={`${getIsHighlighted("/")} ${getNavLinkClass("/about")} text-[0.75rem] md:text-[0.8rem] lg:text-[1rem]`}>About</div></NavLink>
                    </div>
                ...
                <div className="right flex-row items-center gap-4 flex">
